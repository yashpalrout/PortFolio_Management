	...
	return (
		<div className="min-h-screen flex flex-col bg-black text-white">
			...
			<main className="flex-grow flex flex-col items-center gap-12 p-8 pb-20 sm:p-20">
				...
				{/* Auth Check */}
				<div className="absolute bottom-[0%] left-1/2 transform -translate-x-1/2 flex flex-col gap-6 items-center w-full">
					{!isAuthenticated ? (
						<AuthDialog />
					) : (
						<Link href="/console/dashboard" className="px-6 py-3 bg-neutral-800 text-neutral-50 font-medium rounded-md hover:bg-neutral-900 transition bounce">

	...
	return (
		<>
			...
			<motion.button
				layoutId={layout ? `card-${card.title}` : undefined}
				onClick={handleOpen}
				className='rounded-3xl bg-gray-100 dark:bg-neutral-900 h-80 w-[500px] md:h-[400px] md:w-[600px] overflow-hidden flex flex-col items-start justify-start relative z-10'
			>
	...
	return (
		<div className={cn('relative w-full h-full', className)}>
			<Image
				...
				className={cn('object-cover', isLoading ? 'blur-sm' : '')}
				{...rest}
			/>
		</div>
	);
